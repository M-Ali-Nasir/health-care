...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/stylesheet appointment alert history page.css') }}">
</head>

<body>
    <header>
        <h1>Appointment Alert History</h1>
    </header>
    <main>
        <section class="alarm-history">
            <h2>Saved Appointment Alerts</h2>
            <table>
                <thead>
                    <tr>
                        <th>Year</th>
        ...
        <section class="add-alarm1">
            <button1 type="Add Alarm"><a href="{{ route('appointment-alert-set') }}" class="add-alarm1"> Add New
                    Alert</a>
            </button1>
        </section>
    </main>
